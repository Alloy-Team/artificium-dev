...
summon witch ^-4 ^ ^ {DeathLootTable:"empty",NoAI:1b,Health:26f,PatrolLeader:0b,Patrolling:0b,HasRaidGoal:0b,CanJoinRaid:0b,Tags:["art.coven_boss","art.inactive_boss"],Attributes:[{Name:generic.max_health,Base:26}]}
summon witch ^-2 ^ ^-2 {DeathLootTable:"empty",NoAI:1b,Health:26f,PatrolLeader:0b,Patrolling:0b,HasRaidGoal:0b,CanJoinRaid:0b,Tags:["art.coven_boss","art.inactive_boss"],Attributes:[{Name:generic.max_health,Base:26}]}
summon witch ^ ^ ^-4 {DeathLootTable:"empty",NoAI:1b,Health:26f,PatrolLeader:0b,Patrolling:0b,HasRaidGoal:0b,CanJoinRaid:0b,Tags:["art.coven_boss","art.inactive_boss"],Attributes:[{Name:generic.max_health,Base:26}]}
summon witch ^2 ^ ^-2 {DeathLootTable:"empty",NoAI:1b,Health:26f,PatrolLeader:0b,Patrolling:0b,HasRaidGoal:0b,CanJoinRaid:0b,Tags:["art.coven_boss","art.inactive_boss"],Attributes:[{Name:generic.max_health,Base:26}]}
summon witch ^4 ^ ^ {DeathLootTable:"empty",NoAI:1b,Health:26f,PatrolLeader:0b,Patrolling:0b,HasRaidGoal:0b,CanJoinRaid:0b,Tags:["art.coven_boss","art.inactive_boss"],Attributes:[{Name:generic.max_health,Base:26}]}
