...
execute if score @s art_gpoundAnim matches 46..60 run say charging up
execute if score @s art_gpoundAnim matches 27..46 run say going to hit
execute if score @s art_gpoundAnim matches 20..27 run say hitting
