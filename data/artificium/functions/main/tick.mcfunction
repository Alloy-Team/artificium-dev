...
execute as @e[type=minecraft:armor_stand,tag=art.sandstone_golem] at @s unless entity @e[type=minecraft:iron_golem,tag=art.sandstone_golem,sort=nearest,limit=1,distance=..3] run function artificium:bosses/sandstone_golem/stages/death
